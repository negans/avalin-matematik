...
Klart: Fas 1–4 (SINGMA 5A/5B + mönster v2 på alla 9 filer + innehållsluckor), Fas 5 steg 14–17b (skala, proportionalitet, geometri M9 3D-former + M10 volym), statistik M6 median (Lgr22-gap), samt första pass av Fas 8 steg 22+25 (2026-07-03). Detaljer i HISTORIK.md.
